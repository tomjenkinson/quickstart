...
NARAYANA_BRANCH="${NARAYANA_BRANCH:-LRA}"
QUICKSTART_NARAYANA_VERSION=${QUICKSTART_NARAYANA_VERSION:-5.10.0.Final-SNAPSHOT}
...
function int_env {
  ...
  [ $NARAYANA_CURRENT_VERSION ] || export NARAYANA_CURRENT_VERSION="5.10.0.Final-SNAPSHOT" 
...
function build_narayana {
  ...
  cp -rp narayana-full/target/narayana-full-5.10.0.Final-SNAPSHOT-bin.zip $WORKSPACE
  cd ..
  rm -rf narayana
}
